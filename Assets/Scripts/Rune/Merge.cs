...
namespace Rune
{
    public class Merge : MonoBehaviour
    {
        ...
        #region Testing
        [SerializeField] private Rune[] sdk;
        ...
        public void RuneMerge()
        {
            ...
            var rarity = mergeData.runes[0].data.Rarity; //current rarity of all runes in list of runes to merge
        ...
        private HashSet<Type> TypesInList()
        {
            ...
            {
                typesInMergeList.Add(rune.data.RuneType);
            }
